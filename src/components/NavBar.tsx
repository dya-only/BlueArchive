    ...
    <div className="navbar flex items-center justify-between tracking-tight fixed bg-[#f2fafd] shadow-lg rounded-b-4xl h-[60px] w-screen mb-12">
      ...
      <div className="front-menu flex items-center">
        ...
        <div className="first fixed flex items-center justify-center">
          ...
          <div className="title text-[#2c4663] tracking-tight text-4xl border-b-4 h-[47px] -ml-12 mt-3 pl-8 border-[#ffe03d]">{ props.name }</div>
      ...
      <div className="sub-line bg-neutral-300 w-[2px] h-[26px] rotate-[12deg] mr-6"></div>

        <button className="setting-btn mt-1 mr-6">
        ...
        <Link to="/">
          <button className="home-btn mt-1 mr-9">
